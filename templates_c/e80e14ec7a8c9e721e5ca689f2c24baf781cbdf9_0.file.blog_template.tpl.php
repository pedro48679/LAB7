<?php
/* Smarty version 4.3.4, created on 2025-10-31 01:41:47
  from 'C:\xampp\htdocs\LAB7\templates\blog_template.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_690405cb70c7c9_42009059',
...
function content_690405cb70c7c9_42009059 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
">
              ...
              <input type="hidden" name="micropost_id" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['micropost_id']->value ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
">

              <!-- Blog Content -->
              <div class="mb-4">
                <label for="blog_content">Blog Content</label>
                <textarea class="form-control" id="blog_content" name="blog_content" rows="5" placeholder="Write your post here"><?php echo (($tmp = $_smarty_tpl->tpl_vars['blog']->value ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
</textarea>
              </div>
    ...
    <?php echo '<script'; ?>
 src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js" integrity="sha384-6k+gYmM9mD8l7hYYh0pm60mcptTtqLVG6A9lMl60b6gXfh4yP5JHTJxlzFmjOks2" crossorigin="anonymous"><?php echo '</script'; ?>
>    
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css">
    <?php echo '<script'; ?>
 src="https://cdn.jsdelivr.net/npm/particles.js@2.0.0/particles.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
>
